...
export default function HeroContent() {
    ...
    return (
        <div className="flex flex-col justify-start sm:justify-center text-center sm:text-left
                    items-center sm:items-start gap-4 md:gap-10 w-[90%] sm:w-full sm:min-w-85 md:min-w-100 lg:min-w-148 max-w-11/12 sm:max-w-2xl
                    h-auto sm:h-full p-0 px-[5%] sm:px-0 sm:py-0 sm:pl-17 z-10"
        >
